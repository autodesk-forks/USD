...
#if defined (ARCH_CPU_INTEL) || defined (ARCH_CPU_ARM) || defined(ARCH_OS_WASM_VM) || defined (doxygen)
...
{
#if defined(ARCH_COMPILER_GCC) || defined(ARCH_COMPILER_CLANG) && !defined(ARCH_OS_WASM_VM)
