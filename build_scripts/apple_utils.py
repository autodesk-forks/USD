...
def SetTarget(context):
    ...
    # wasm / wasm64 / node are valid --build-target values on macOS hosts but are
    # not Apple SDK targets; normalizeBuildTarget returns None for those.
    if targetName is None:
        targetName = context.buildTarget
