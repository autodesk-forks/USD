...
# Autodesk: update to v1.3.1 for security patch.
    ...
    with CurrentWorkingDirectory(sourceDir):
        ...
        if MacOS() and not context.targetWasm:
            ...
            if macOSArch and macOSTarget:
                bootstrapCmd += " cxxflags=\"{0} {1} -std=c++17 -stdlib=libc++\" " \
                                " cflags=\"{0} {1}\" " \
                                " linkflags=\"{0} {1}\" " \
                                " mflags=\"{1}\" " \
        ...
        if MacOS():
            ...
            if macOSArch and macOSTarget:
                b2_settings.append("cxxflags=\"{0} {1} -std=c++17 -stdlib=libc++\"".format(macOSArch, macOSTarget))
                ...
                b2_settings.append("cxxflags=\"{0} -std=c++17 -stdlib=libc++\"".format(macOSTarget))
...
# Autodesk: update to v3.3.6 for security fixes.
OPENEXR_URL = "https://github.com/AcademySoftwareFoundation/openexr/archive/refs/tags/v3.4.3.zip"
...
# Autodesk: update MatX version as 1.39.3 contains many bugs
